...
boolean finger = false;           // photocell indicates if finger is in place
...
void setup(){
  ...
  pinMode(photoCellPin, INPUT);     // declare the photoresistor as an input - used to determine presence of finger
...
void loop(){
  ...
  //If a finger is present,send the data
  if(finger==true){ 
